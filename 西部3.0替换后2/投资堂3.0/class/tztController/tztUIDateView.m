...
- (void)initdata
{
    ...
    if (_pEndDate == nil)
    {
        self.pEndDate = [[NSDate date] dateByAddingTimeInterval:(-1.0 * 24 * 60 * 60)];
    }
    if (_pTableV == nil)
    {
...
{
    NSLog(@"_tztDatePicker.tztDatePicker.maximumDate----%@",_tztDatePicker.tztDatePicker.maximumDate);
