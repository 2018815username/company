...
#define PP_ONLYRELEASE(xx)                         [xx release]
 ...
 *  支持左侧侧滑显示
 */
extern NSInteger   g_nSupportLeftSide;
/**
 *  支持右侧侧滑显示
 */
extern NSInteger   g_nSupportRightSide;
...
@property (nonatomic) BOOL IgnoredTouch;
/**
...
@property (nonatomic, readonly) BOOL wasClosed;
