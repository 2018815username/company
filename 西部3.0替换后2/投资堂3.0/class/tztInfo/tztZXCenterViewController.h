...
@interface tztZXCenterViewController : TZTUIBaseViewController<tztInfoDelegate,tztHqBaseViewDelegate>
{
    //一级菜单
    tztInfoTableView    *_tztFirstInfoView;
    //二级菜单
...
@property(nonatomic, retain)tztInfoTableView    *tztFirstInfoView;
