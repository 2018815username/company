...
@interface tztUITradeViewController_iPad : TZTUIBaseViewController<tztUITableListViewDelegate,tztHqBaseViewDelegate,UIGestureRecognizerDelegate, tztTabViewDelegate , tztTradeSegmentDelegate>
{
