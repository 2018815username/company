...
//                        strPath = [strAction substringToIndex:pathRang.location-1];
                ...
                [_tztDelegate tztperformSelector:@"setRiskSign:" withObject:strParam];
...
//                }
    ...
    else if ([strUrllower hasPrefix:@"http://browseropen:"])
    {
        NSString* strTelCode = [strUrl substringFromIndex:[@"http://browseropen:" length]];
        NSString* strTelPhone = [NSString stringWithFormat:@"%@",strTelCode];
        [[UIApplication sharedApplication] openURL:[NSURL URLWithString:strTelPhone]];
        return tztHTTPWebViewFalse | tztHTTPWebViewBreak;
    }
#endif
//    
