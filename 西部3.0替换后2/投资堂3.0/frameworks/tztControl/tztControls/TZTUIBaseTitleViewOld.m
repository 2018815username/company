...
/*市场类型*/
@property(nonatomic)NSInteger  nStockType;
...
//    rcLeftTitle.origin.x += rcEditBtn.size.width;
    ...
    if (pBtnFull == NULL)
    {
        ...
        [pBtnFull setShowsTouchWhenHighlighted:NO];
...
//    rcFullScreen.origin.y = rcLeftTitle.origin.y + (rcLeftTitle.size.height - 32) / 2;
    ...
    if (pBtnPre == nil)
    {
        ...
        [pBtnPre setShowsTouchWhenHighlighted:NO];
    ...
    if (pBtnNext == nil)
    {
        ...
        [pBtnNext setShowsTouchWhenHighlighted:NO];
...
//		self.pSearchBar.keyboardType =  UIKeyboardTypeDefault;
        ...
        if (IS_TZTIOS(7))
        {
            ...
            self.pSearchBar.backgroundImage = [UIImage tztCreateImageWithColor:[UIColor clearColor]];
        }
        else
...
//                [_firstBtn setTztTitle:@"返回"];
    ...
    else
    {
        ...
        if(nTitleType == TZTTitleStock)
        {
            ...
            {
                if (MakeHKMarket((int)_nStockType))
                {
            ...
            CGRect rcCode = CGRectMake((_titlelabel.frame.size.width - nWidth)/2, _titlelabel.frame.size.height *2 / 3, nCodeWidth, _titlelabel.frame.size.height / 3);
            ...
            if (_nStockType > 0)
            {
                ...
                rcImg.origin.x += rcCode.size.width + 5;
...
//                rcImg.size = CGSizeMake(nIcoWidth, nIcoWidth);
                ...
                if (_nStatus > 0)
                {
                    ...
                    if (pViewBack == NULL)
                    {
                        ...
                        pViewBack.backgroundColor = [UIColor colorWithTztRGBStr:@"187,46,37"];
                    ...
                    if (pLabel == NULL)
                    {
                        ...
                        pLabel.textColor = [UIColor colorWithTztRGBStr:@"254,226,142"];//[UIColor whiteColor];
                        pLabel.textAlignment = NSTextAlignmentCenter;
                        pLabel.text = @"可买卖";
    ...
    switch (nSecondType)
    {
        case TZTTitlePreNext:
        {
            ...
            if (_secondBtn == nil)
            {
                ...
                [_secondBtn setShowsTouchWhenHighlighted:NO];
            ...
            if (_thirdBtn == nil)
            {
                ...
                [_thirdBtn setShowsTouchWhenHighlighted:NO];
        ...
        case TZTTitleEditor:
        {
            ...
            {
                _thirdBtn = [UIButton buttonWithType:UIButtonTypeCustom];
                _thirdBtn.tag = HQ_MENU_EditUserStock;
                [_thirdBtn setShowsTouchWhenHighlighted:NO];
                [_thirdBtn setContentMode:UIViewContentModeCenter];
