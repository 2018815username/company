...
#import "tztUITTYYYQKViewController.h"

@implementation tztUITTYYYQKViewController
...
-(void)LoadLayoutView
{
    ...
    if (_pTradeView == nil)
    {
        _pTradeView = [[tztTTYYYQKView alloc] init];
...
//        }
        if (_pTradeView && [_pTradeView respondsToSelector:@selector(OnQueryNextDate)])
        {
            [_pTradeView OnQueryNextDate];
        }
