...
-(void)setFrame:(CGRect)frame
{
    ...
    if (_tztTradeView == NULL)
    {
        ...
        if (_bBuyFlag)
            ...
            _tztTradeView.tableConfig = @"tztUIHKTradeSaleStock";
    ...
    if (_pBtnOK == NULL)
    {
        _pBtnOK = [[tztUIButton alloc] initWithProperty:@"tag=5000|type=custom|title=买  入|font=19|"];
    ...
    _pBtnOK.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageTztNamed:(_bBuyFlag? @"TZTStockTradeBuy.png" : @"TZTStockTradeSell.png")]];
    
    if (_pBtnSwitch == NULL)
    {
        _pBtnSwitch = [[tztUIButton alloc] initWithProperty:@"tag=5001|type=custom|title=买/卖|font=12"];
    ...
    {
        _pBtnRefresh = [[tztUIButton alloc] initWithProperty:@"tag=5002|type=custom|title=刷新|font=12"];
    ...
    if (_pBtnClear == NULL)
    {
        _pBtnClear = [[tztUIButton alloc] initWithProperty:@"tag=5003|type=custom|title=清空|font=12"];
    ...
    _pLabelInfo.textColor = [UIColor tztThemeTextColorLabel];
    ...
    rcDetail.size.height -= (rcDetail.origin.y);
    
    
    NSString *strConfig = @"tztUIHKTradeDetailNoRight";
    _nHaveGGTRight = tztHaveHKRight();
    if (_nHaveGGTRight > 0)
        strConfig = @"tztUIHKTradeDetail";
    if (_tztDetailView == NULL)
    {
        ...
        _tztDetailView.tableConfig = strConfig;
        ...
        _tztDetailView.frame = rcDetail;
    _tztDetailView.backgroundColor = [UIColor tztThemeBackgroundColorJY];
...
-(void)setShowStyle
{
    ...
    UIView *pView = nil;
    float fBtnWidth = 47;
    float fLeftWidth = (self.frame.size.width - fBtnWidth * 2);
    float fUnitWidth = fLeftWidth / 2 - 20;
    ...
    if (pView)
    {
        ...
        {
            ((tztUITextField*)pView).textColor = [UIColor tztThemeTextColorEditor];
            ((tztUITextField*)pView).clPlaceHolder = [UIColor lightGrayColor];
            CGRect rc = pView.frame;
            rc.size.width = (self.frame.size.width - rc.origin.x * 2);
            pView.frame = rc;
            pView.backgroundColor = self.backgroundColor;
            pView.layer.borderWidth = 0;
        }
    }
    
    pView = [_tztTradeView getViewWithTag:kTagListCode];
    if (pView && [pView isKindOfClass:[tztUIDroplistView class]])
    {
        ((tztUIDroplistView*)pView).textfield.textColor = [UIColor tztThemeTextColorEditor];
        ((tztUIDroplistView*)pView).textfield.clPlaceHolder = [UIColor lightGrayColor];
        CGRect rc = pView.frame;
        rc.size.width = (self.frame.size.width - rc.origin.x * 2);
        ((tztUIDroplistView*)pView).textfield.backgroundColor = self.backgroundColor;
        ((tztUIDroplistView*)pView).textfield.textColor = [UIColor tztThemeTextColorEditor];
        ((tztUIDroplistView*)pView).textfield.layer.borderWidth = 0;
        ((tztUIDroplistView*)pView).textColor = [UIColor tztThemeTextColorEditor];
        ((tztUIDroplistView*)pView).backgroundColor = self.backgroundColor;
        ((tztUIDroplistView*)pView).dropbtn.backgroundColor = self.backgroundColor;
        ((tztUIDroplistView*)pView).pBackView.layer.borderWidth = 0;
    ...
    if (pView && [pView isKindOfClass:[tztUIDroplistView class]])
    {
        ...
        rc.size.width = (self.frame.size.width - rc.origin.x * 2);
        ((tztUIDroplistView*)pView).textfield.backgroundColor = self.backgroundColor;
        ((tztUIDroplistView*)pView).textbtn.backgroundColor = self.backgroundColor;
        ((tztUIDroplistView*)pView).textfield.textColor = [UIColor tztThemeTextColorEditor];
        ((tztUIDroplistView*)pView).textColor = [UIColor tztThemeTextColorEditor];
        ((tztUIDroplistView*)pView).backgroundColor = self.backgroundColor;
        ((tztUIDroplistView*)pView).dropbtn.backgroundColor = self.backgroundColor;
    ...
    if (pView && [pView isKindOfClass:[tztUIButton class]])
    {
        ...
        {
            _pLabelPriceDel = [[tztUILabel alloc] initWithProperty:@"text=0.001|font=10|textalignment=center|textcolor=255,255,255"];
    ...
    {
        CGRect rc = pView.frame;
        rc.origin.x = fBtnWidth + fUnitWidth;
        rc.size.width = fLeftWidth - fUnitWidth;
        
        ((tztUITextField*)pView).textAlignment = NSTextAlignmentLeft;
        ((tztUITextField*)pView).textColor = [UIColor tztThemeTextColorEditor];
        ((tztUITextField*)pView).backgroundColor = self.backgroundColor;
        ((tztUITextField*)pView).clPlaceHolder = [UIColor lightGrayColor];
        pView.layer.borderWidth = 0;
        pView.frame = rc;
    }
    ...
    if (pView && [pView isKindOfClass:[tztUIButton class]])
    {
        ...
        {
            _pLabelPriceAdd = [[tztUILabel alloc] initWithProperty:@"text=0.001|font=10|textalignment=center|textcolor=255,255,255|"];
    ...
    if (pView && [pView isKindOfClass:[tztUIButton class]])
    {
        ...
        {
            _pLabelAmountDel = [[tztUILabel alloc] initWithProperty:@"text=1000|font=10|textalignment=center|textcolor=255,255,255|"];
    ...
    if (pView && [pView isKindOfClass:[tztUIButton class]])
    {
        ...
        {
            _pLabelAmountAdd = [[tztUILabel alloc] initWithProperty:@"text=1000|font=10|textalignment=center|textcolor=255,255,255|"];
    ...
    if (pView && [pView isKindOfClass:[tztUILabel class]])
    {
        ((tztUILabel*)pView).textColor = [UIColor tztThemeHQUpColor];
//        ((tztUILabel*)pView).text = @" ¥12345678";
    ...
    if (pView && [pView isKindOfClass:[tztUILabel class]])
    {
        ...
        ((tztUILabel*)pView).textColor = [UIColor tztThemeTextColorLabel];
        ((tztUILabel*)pView).adjustsFontSizeToFitWidth = YES;
...
//        ((tztUIButton*)pView).titleLabel.adjustsFontSizeToFitWidth = YES;
    ...
    pView.backgroundColor = [UIColor tztThemeBackgroundColor];
}
...
-(void)ClearData
{
    ...
    [_tztTradeView setComBoxData:NULL ayContent_:NULL AndIndex_:-1 withTag_:kTagListCode];
    [_tztTradeView setComBoxText:@"" withTag_:kTagListCode];
...
-(void)setStockCode:(NSString *)strCode
{
    ...
    if (_tztTradeView)
    {
        ...
        {
            [_tztTradeView setComBoxText:self.CurStockCode withTag_:kTagListCode];
            [self OnRefresh:YES];
        }
    }
}
...
-(void)OnRefresh:(BOOL)bStockInfo
{
    ...
    tztZJAccountInfo *pAccount = tztGetCurrentAccountHKRight();
    if (pAccount)
    {
        if (pAccount.nsAccount && pAccount.nsAccount.length > 0)
            [pDict setTztObject:pAccount.nsAccount forKey:@"Account"];
        if (pAccount.Ggt_rights && pAccount.Ggt_rights.length > 0)
            [pDict setTztObject:pAccount.Ggt_rights forKey:@"Ggt_rights"];
        if (pAccount.Ggt_rightsEndDate && pAccount.Ggt_rightsEndDate.length > 0)
            [pDict setTztObject:pAccount.Ggt_rightsEndDate forKey:@"Ggt_rightsEndDate"];
    }
    _bRequestHQ = YES;
...
-(void)OnRequestStockInfo
{
    ...
    [pDict setTztObject:@"100" forKey:@"MaxCount"];
    if (self.nsNewPrice)
...
-(void)RequestHKCCData
{
    ...
    [pDict setTztObject:@"200" forKey:@"MaxCount"];
    [[tztMoblieStockComm getShareInstance] onSendDataAction:@"5106" withDictValue:pDict];
    DelObject(pDict);
}
...
-(void)OnSendBuySell:(BOOL)bSend
{
    ...
    //获取委托类型
    NSInteger nSelectIndex = [_tztTradeView getComBoxSelctedIndex:kTagListType];
...
-(NSUInteger)OnCommNotify:(NSUInteger)wParam lParam_:(NSUInteger)lParam
{
    ...
    else if ([pParse IsAction:@"5106"])
    {
        ...
        int nMin = MIN(nCodeIndex, nNameIndex);
        ...
        if (nMin >= 0)
        {
            ...
            for (int i = 0; i < ayGrid.count; i++)
            {
                ...
                NSInteger nCount = ayValue.count;
                if (ayValue == NULL || nCount < nMin)
                    continue;
                if (nCodeIndex < nCount)
                    strCode = [ayValue objectAtIndex:nCodeIndex];
                if (strCode == NULL || strCode.length < 1)
                    continue;
                
                if (nNameIndex < nCount)
                    strName = [ayValue objectAtIndex:nNameIndex];
                if (strName == NULL)
                    strName = @"";
        ...
        {
            [_tztTradeView setComBoxData:pAyTitle
                              ayContent_:pAyTitle
                               AndIndex_:-1
                                withTag_:kTagListCode
                                  bDrop_:YES];
        }
        else
        {
    ...
    else if ([pParse IsAction:@"5100"] || [pParse IsAction:@"5101"])
    {
        ...
        NSString *strTime = [pParse GetByName:@"currentTime"];
        ...
        if (strTime && strTime.length > 0)
        {
            ...
            if (ay.count >= 2)
            {
                ...
                //获取时间//00:00-09:30竞价限价 9:30-23:59增强限价
                int nMinutes = nHour * 60 + nMin;
                UIView *pView = [_tztTradeView getViewWithTag:kTagListType];
                if (pView && [pView isKindOfClass:[tztUIDroplistView class]])
                {
                    int nIndex = 0;
                    if ( nMinutes >= 9*60 +30 && nMinutes <= 23*60+59)//增强限价
                        nIndex = 1;
                    ((tztUIDroplistView*)pView).selectindex = nIndex;
                }
            }
        }
...
-(void)DealHQData:(tztNewMSParse*)pParse
{
    ...
    if ([pParse IsAction:@"43"])
    {
        ...
        if (DataGrid && nDataLen > 0)
        {
            ...
            if (pZJAccount)
            {
                NSString* strGgtRight = [pParse GetByName:@"Ggt_rights"];
                if (strGgtRight && strGgtRight.length > 0)
                {
                    bHaveRight = ([strGgtRight intValue] > 0);
                    pZJAccount.Ggt_rights = [NSString stringWithFormat:@"%@", strGgtRight];
                }
                else
                    pZJAccount.Ggt_rights = @"";
                
                NSString* strGgtRightEndDate = [pParse GetByName:@"Ggt_rightsEndDate"];
            ...
            bHaveRight = tztHaveHKRight();
            if (bHaveRight != _nHaveGGTRight)//重新设置底部十档、一档切换显示
            {
                _nHaveGGTRight = bHaveRight;
                
                NSString *strConfig = @"tztUIHKTradeDetailNoRight";
                if (_nHaveGGTRight > 0)
                    strConfig = @"tztUIHKTradeDetail";
                [_tztDetailView setTableConfig:strConfig];
                [_tztDetailView setFrame:_tztDetailView.frame];
            }
            ...
            {
                UIView* pView = [_tztTradeView  getViewWithTag:kTagListCode];
                BOOL bFouce = FALSE;
                if (pView && [pView isKindOfClass:[tztUIDroplistView class]])
                {
                    bFouce = [((tztUIDroplistView*)pView).textfield isFirstResponder];
                }
                if (!bFouce)
                    [_tztTradeView setComBoxText:[NSString stringWithFormat:@"%@ %@", self.nsStockName, self.CurStockCode] withTag_:kTagListCode];
            }
            ...
            /*卖6-卖10*/
            [self SetValueForDetail:pPriceDataEx.pSell1
                           nCompare:pPriceData.Close_p
                             nDivd_:nPriceDiv
                          nDecimal_:pPriceData.nDecimal
                              nTag_:kTagBtnSellPrice+5
                           bVolume_:NO];
            
            [self SetValueForDetail:pPriceDataEx.QSell1
                           nCompare:0
                             nDivd_:nDiv
                          nDecimal_:0
                              nTag_:kTagBtnSellVolume+5
                           bVolume_:YES];
            //卖7
            [self SetValueForDetail:pPriceDataEx.pSell2
                           nCompare:pPriceData.Close_p
                             nDivd_:nPriceDiv
                          nDecimal_:pPriceData.nDecimal
                              nTag_:kTagBtnSellPrice+6
                           bVolume_:NO];
            
            [self SetValueForDetail:pPriceDataEx.QSell2
                           nCompare:0
                             nDivd_:nDiv
                          nDecimal_:0
                              nTag_:kTagBtnSellVolume+6
                           bVolume_:YES];
            
            //卖8
            [self SetValueForDetail:pPriceDataEx.pSell3
                           nCompare:pPriceData.Close_p
                             nDivd_:nPriceDiv
                          nDecimal_:pPriceData.nDecimal
                              nTag_:kTagBtnSellPrice+7
                           bVolume_:NO];
            
            [self SetValueForDetail:pPriceDataEx.QSell3
                           nCompare:0
                             nDivd_:nDiv
                          nDecimal_:0
                              nTag_:kTagBtnSellVolume+7
                           bVolume_:YES];
            
            //卖9
            [self SetValueForDetail:pPriceDataEx.pSell4
                           nCompare:pPriceData.Close_p
                             nDivd_:nPriceDiv
                          nDecimal_:pPriceData.nDecimal
                              nTag_:kTagBtnSellPrice+8
                           bVolume_:NO];
            
            [self SetValueForDetail:pPriceDataEx.QSell4
                           nCompare:0
                             nDivd_:nDiv
                          nDecimal_:0
                              nTag_:kTagBtnSellVolume+8
                           bVolume_:YES];
            
            //卖10
            [self SetValueForDetail:pPriceDataEx.pSell5
                           nCompare:pPriceData.Close_p
                             nDivd_:nPriceDiv
                          nDecimal_:pPriceData.nDecimal
                              nTag_:kTagBtnSellPrice+9
                           bVolume_:NO];
            
            [self SetValueForDetail:pPriceDataEx.QSell5
                           nCompare:0
                             nDivd_:nDiv
                          nDecimal_:0
                              nTag_:kTagBtnSellVolume+9
                           bVolume_:YES];
            ...
            //买6 价、量
            [self SetValueForDetail:pPriceDataEx.pBuy1
                           nCompare:pPriceData.Close_p
                             nDivd_:nPriceDiv
                          nDecimal_:pPriceData.nDecimal
                              nTag_:kTagBtnBuyPrice+5
                           bVolume_:NO];
            [self SetValueForDetail:pPriceDataEx.QBuy1
                           nCompare:0
                             nDivd_:nDiv
                          nDecimal_:0
                              nTag_:kTagBtnBuyVolume+5
                           bVolume_:YES];
            
            //买7 价、量
            [self SetValueForDetail:pPriceDataEx.pBuy2
                           nCompare:pPriceData.Close_p
                             nDivd_:nPriceDiv
                          nDecimal_:pPriceData.nDecimal
                              nTag_:kTagBtnBuyPrice+6
                           bVolume_:NO];
            [self SetValueForDetail:pPriceDataEx.QBuy2
                           nCompare:0
                             nDivd_:nDiv
                          nDecimal_:0
                              nTag_:kTagBtnBuyVolume+6
                           bVolume_:YES];
            
            //买8 价、量
            [self SetValueForDetail:pPriceDataEx.pBuy3
                           nCompare:pPriceData.Close_p
                             nDivd_:nPriceDiv
                          nDecimal_:pPriceData.nDecimal
                              nTag_:kTagBtnBuyPrice+7
                           bVolume_:NO];
            [self SetValueForDetail:pPriceDataEx.QBuy3
                           nCompare:0
                             nDivd_:nDiv
                          nDecimal_:0
                              nTag_:kTagBtnBuyVolume+7
                           bVolume_:YES];
            
            //买9 价、量
            [self SetValueForDetail:pPriceDataEx.pBuy4
                           nCompare:pPriceData.Close_p
                             nDivd_:nPriceDiv
                          nDecimal_:pPriceData.nDecimal
                              nTag_:kTagBtnBuyPrice+8
                           bVolume_:NO];
            [self SetValueForDetail:pPriceDataEx.QBuy4
                           nCompare:0
                             nDivd_:nDiv
                          nDecimal_:0
                              nTag_:kTagBtnBuyVolume+8
                           bVolume_:YES];
            
            //买10 价、量
            [self SetValueForDetail:pPriceDataEx.pBuy5
                           nCompare:pPriceData.Close_p
                             nDivd_:nPriceDiv
                          nDecimal_:pPriceData.nDecimal
                              nTag_:kTagBtnBuyPrice+9
                           bVolume_:NO];
            [self SetValueForDetail:pPriceDataEx.QBuy5
                           nCompare:0
                             nDivd_:nDiv
                          nDecimal_:0
                              nTag_:kTagBtnBuyVolume+9
                           bVolume_:YES];
        ...
        case kTagListCode:
        {
            if (self.CurStockCode.length == 5)
            {
                if (self.nsStockName && self.nsStockName.length > 0)
                    ...
                    [_tztTradeView setComBoxText:[NSString stringWithFormat:@"%@", self.CurStockCode] withTag_:kTagListCode];
            }
        }
            break;
        case kTagTextPrice:
...
{
    int nTag = [((tztUITextField*)tztUIBaseView).tzttagcode intValue];
    if ( nTag == kTagTextStockCode || nTag == kTagListCode
        )
    {
        if (self.CurStockCode.length == 5)
        {
            if (nTag == kTagListCode)
            {
                [_tztTradeView setComBoxText:self.CurStockCode withTag_:nTag];
            }
            else
                [_tztTradeView setEditorText:self.CurStockCode nsPlaceholder_:nil withTag_:nTag andNotifi:NO];
        }
    }
}
...
-(void)OnButtonClick:(id)sender
{
    ...
    else if (nTag == kTagBtnSwitch)//切换
    {
        ...
        [TZTUIBaseVCMsg OnMsg:(_bBuyFlag ? MENU_JY_HK_Sell : MENU_JY_HK_Buy ) wParam:(NSUInteger)pStockInfo lParam:1];
        [pStockInfo release];
    }
...
-(void)tztDroplistView:(tztUIDroplistView *)droplistview didSelectIndex:(int)index
{
    switch ([droplistview.tzttagcode intValue])
    {
        ...
        case kTagListCode:
        {
            ...
            if (rangeLeft.location > 0 && (rangeLeft.location+6) < [strTitle length])
            {
                NSRange range = NSMakeRange(rangeLeft.location+1, 5);
                NSString *strCode = [strTitle substringWithRange:range];
                //设置股票代码
                [_tztTradeView setComBoxText:strCode withTag_:kTagListCode];
                [self ClearDataWithOutCode];
                self.CurStockCode = [NSString stringWithFormat:@"%@", strCode];
                if (self.CurStockCode.length == 5)
                    [self OnRefresh:YES];
...
{
    if ([droplistview.tzttagcode intValue] == kTagListCode)
    {
        [self RequestHKCCData];
    }
}
@end
