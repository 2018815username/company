...
@property(nonatomic,retain) NSMutableDictionary *dictOption;


//wry---

@property (nonatomic,retain) NSMutableArray* yxdArray;//意向单
@property (nonatomic,retain) NSMutableArray* ydhArray;//约定号
@property (nonatomic,retain) NSMutableArray* xwhArray;//席位号
